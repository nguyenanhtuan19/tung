...
define('CURRENT_DOMAIN', current_domain() . '/webTinTuc/');
...
uri('search/', 'App\Home', 'search');
uri('comment-store', 'App\Home', 'commentStore', 'POST');
uri('like-post/{id}', 'App\Home', 'likePost');
uri('like-post/{id}', 'App\Home', 'likePost', 'POST');
uri('share-post/{id}', 'App\Home', 'sharePost');
uri('userlogin', 'App\Home', 'userlogin', 'POST');
